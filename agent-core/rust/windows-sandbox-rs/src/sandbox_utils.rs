...
//! Lyra home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox Lyra home directory exists.
pub fn ensure_lyra_home_exists(p: &Path) -> Result<()> {
