...
/// 2. The vendored bubblewrap tree under `agent-core/rust/vendor/bubblewrap`.
...
Set CODEX_BWRAP_SOURCE_DIR to an existing checkout or vendor bubblewrap under agent-core/rust/vendor.",
        vendor_dir.display()
    ))
}
