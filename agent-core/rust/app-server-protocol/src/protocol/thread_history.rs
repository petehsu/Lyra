...
use lyra_protocol::protocol::ContextCompactedEvent;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `agent-core/rust/core/rollout/policy.rs`.
    ...
    fn handle_item_started(&mut self, payload: &ItemStartedEvent) {
        match &payload.item {
            ...
            | lyra_protocol::items::TurnItem::ContextCompaction(_) => {}
        }
    }
