...
use lyra_core_plugins::marketplace::find_marketplace_manifest_path;
...
pub fn marketplace_install_root(lyra_home: &Path) -> PathBuf {
...
pub(crate) fn installed_marketplace_roots_from_config(
    ...
    let default_install_root = marketplace_install_root(lyra_home);
