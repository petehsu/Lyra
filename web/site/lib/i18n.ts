...
const dictionaries: Record<SiteLocale, SiteCopy> = {
  zh: {
    ...
    download: {
      ...
      action: "下载",
      platforms: [
        { name: "macOS", detail: "Apple Silicon 桌面安装包", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-darwin-arm64.dmg", available: true },
        { name: "macOS", detail: "Intel 桌面安装包", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-darwin-x64.dmg", available: true },
        { name: "Windows", detail: "Windows 桌面安装包", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-windows-x64.exe", available: true },
        { name: "Linux", detail: "Linux 桌面安装包 (AppImage)", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-linux-x64.AppImage", available: true }
      ],
      upcomingTitle: "接下来",
  ...
  en: {
    ...
    download: {
      ...
      action: "Download",
      platforms: [
        { name: "macOS", detail: "Apple Silicon desktop installer", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-darwin-arm64.dmg", available: true },
        { name: "macOS", detail: "Intel desktop installer", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-darwin-x64.dmg", available: true },
        { name: "Windows", detail: "Desktop installer for Windows", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-windows-x64.exe", available: true },
        { name: "Linux", detail: "Desktop installer for Linux (AppImage)", href: "https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.5/Lyra-Online-linux-x64.AppImage", available: true }
      ],
