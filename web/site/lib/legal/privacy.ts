...
export const PRIVACY_DOCUMENT: LegalDocument = {
  ...
  sections: [
    section(
      ...
      "发布状态、个人信息处理者与范围",
      notice(
        "Version 1.0.0 is effective from August 6, 2026 for Lyra Desktop 0.1.0-preview.6. The individual operator and current contact details are identified below.",
        "1.0.0 版本自 2026 年 8 月 6 日起对 Lyra Desktop 0.1.0-preview.6 生效。个人运营者及当前联系方式见下文。"
      ),
      paragraph(
      ...
      paragraph(
        "This policy covers Lyra Desktop 0.1.0-preview.6 and the Lyra-operated website and account functions described here. It does not replace the privacy policy of a service you select or visit. The English and Simplified Chinese texts share one version and have equal authority.",
        "本政策适用于 Lyra Desktop 0.1.0-preview.6 以及本文所述由 Lyra 运营的网站和账户功能，不替代您选择或访问的服务自身隐私政策。英文与简体中文文本共享同一版本并具有同等效力。"
      )
    ),
    section(
