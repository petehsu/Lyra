...
export const TERMS_DOCUMENT: LegalDocument = {
  ...
  sections: [
    section(
      ...
      "发布状态与接受方式",
      notice(
        "Version 1.0.0 is effective from August 6, 2026 for Lyra Desktop 0.1.0-preview.8. It governs use after the versioned acceptance described below.",
        "1.0.0 版本自 2026 年 8 月 6 日起对 Lyra Desktop 0.1.0-preview.8 生效，并按照下述版本化确认方式约束确认后的使用。"
      ),
      paragraph(
