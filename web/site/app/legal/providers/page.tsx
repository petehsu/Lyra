...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/legal/providers",
    languages: {
      en: "/legal/providers?lang=en-US",
      "zh-CN": "/legal/providers?lang=zh-CN"
    }
  }
};
...
export default async function ProvidersPage(props: LegalPageProps) {
