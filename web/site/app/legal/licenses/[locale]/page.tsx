...
const copy = {
  ...
  sourceOfferDetail: {
    "en-US":
      "Lyra 0.1.0-preview.6 · aria2, GMP and libiconv source · exact conda package evidence",
    "zh-CN":
      "Lyra 0.1.0-preview.6 · aria2、GMP 与 libiconv 源码 · 精确 conda 包证据"
  },
  packageList: {
    ...
    >
      <section className="legal-license-summary">
        ...
        <div>
          ...
          <a
            className="legal-license-download"
            href="https://github.com/petehsu/lyra-releases/releases/download/v0.1.0-preview.6/SOURCE-OFFER-0.1.0-preview.6-darwin-x64.md"
          >
