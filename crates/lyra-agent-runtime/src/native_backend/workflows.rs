...
pub(crate) fn selfdev_capabilities() -> Vec<SelfDevCapability> {
    vec![
        SelfDevCapability {
            ...
            kind: "file".to_string(),
            available: true,
            tool: "/tools/filesystem/read_file,/tools/filesystem/write_file,/tools/filesystem/edit_file,/tools/filesystem/apply_patch".to_string(),
        },
        SelfDevCapability {
            ...
            available: true,
            tool: "/tools/shell/run_command".to_string(),
        },
        SelfDevCapability {
            ...
            kind: "git".to_string(),
            available: true,
            tool: "/tools/git/status,/tools/git/diff".to_string(),
        },
        SelfDevCapability {
