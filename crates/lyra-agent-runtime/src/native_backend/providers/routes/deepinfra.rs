...
pub(crate) const ROUTE_ID: &str = "deepinfra";
pub(crate) const DEFAULT_BASE_URL: &str = "https://api.deepinfra.com/v1/openai";
...
pub(crate) fn descriptor() -> ProviderRouteDescriptor {
    ProviderRouteDescriptor {
        ...
        label: "DeepInfra".to_string(),
        description: "DeepInfra hosted open models via OpenAI-compatible endpoint.".to_string(),
