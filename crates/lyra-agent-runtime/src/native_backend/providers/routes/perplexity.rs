...
pub(crate) const ROUTE_ID: &str = "perplexity";
pub(crate) const DEFAULT_BASE_URL: &str = "https://api.perplexity.ai";
...
pub(crate) fn descriptor() -> ProviderRouteDescriptor {
    ProviderRouteDescriptor {
        ...
        description: "Perplexity online models via OpenAI-compatible endpoint.".to_string(),
