...
pub(crate) const ROUTE_ID: &str = "cerebras";
pub(crate) const DEFAULT_BASE_URL: &str = "https://api.cerebras.ai/v1";
...
pub(crate) fn descriptor() -> ProviderRouteDescriptor {
    ProviderRouteDescriptor {
        ...
        description: "Cerebras fast inference OpenAI-compatible endpoint.".to_string(),
