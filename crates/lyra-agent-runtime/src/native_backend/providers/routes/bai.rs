...
pub(crate) const ROUTE_ID: &str = "bai";
pub(crate) const DEFAULT_BASE_URL: &str = "https://api.b.ai/v1";
...
pub(crate) fn descriptor() -> ProviderRouteDescriptor {
    ProviderRouteDescriptor {
        ...
        description: "B.AI unified gateway OpenAI-compatible endpoint.".to_string(),
