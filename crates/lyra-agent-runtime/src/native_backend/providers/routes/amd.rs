...
pub(crate) const ROUTE_ID: &str = "amd";
pub(crate) const DEFAULT_BASE_URL: &str = "https://developer.amd.com.cn/radeon/api/v1";

pub(crate) fn descriptor() -> ProviderRouteDescriptor {
    ProviderRouteDescriptor {
        id: ROUTE_ID.to_string(),
        provider_id: "amd".to_string(),
        ...
        description: "AMD Radeon Cloud Token Factory OpenAI-compatible endpoint.".to_string(),
