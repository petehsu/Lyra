...
pub const PROMPT_POLICY_VERSION: u32 = 11;
pub const PROMPT_TEMPLATE_VERSION: u32 = 48;
pub const MEMORY_PROJECTION_VERSION: u32 = 1;
pub const CONTEXT_PROJECTION_VERSION: u32 = 5;
pub const RETENTION_POLICY_VERSION: u32 = 1;
pub const TOOL_DISCOVERY_CONTRACT_VERSION: u32 = 2;
pub const RUNTIME_CONTEXT_SCHEMA_VERSION: u32 = 6;
