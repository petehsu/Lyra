...
use lyra_agent_core::{
    ...
    compact_jcode_session_json, create_session_json, delete_session_json, git_diff_json,
    git_discard_json, git_stage_json, git_status_json, git_unstage_json, list_jcode_accounts_json,
    list_jcode_commands_json, list_jcode_goals_json, list_jcode_models_json,
    list_jcode_overnight_json, list_jcode_sessions_json, log_jcode_overnight_json,
    login_jcode_account_json, open_jcode_goals_json, preview_rollback_json, read_jcode_config_json,
    read_session_json, refactor_session_json, refresh_jcode_models_json, remove_jcode_account_json,
    rename_session_json, respond_permission_json, restore_rollback_json, resume_jcode_goal_json,
    review_jcode_overnight_json, run_improve_session_json, run_jcode_btw_json,
    run_jcode_subagent_json, run_judge_session_json, run_review_session_json,
...
fn handle_jcode_request(method: &str, payload: Value) -> Result<Value, RuntimeError> {
    match method {
        ...
        "jcode.commands.list" => call_json(payload, list_jcode_commands_json),
