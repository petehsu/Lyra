use crate::catalog::common::{map, model, password_field, select_field, text_field, url_field};
...
fn openai_like_preset(
    ...
    AiProviderPreset {
        ...
        auth_fields: if provider_id == "openai" {
            vec![
                select_field(
                    "authMode",
                    "Auth Mode",
                    ...
                    &[
                        ("api_key", "API Key"),
                        ("chatgpt_oauth", "ChatGPT Plus/Pro (Browser OAuth)"),
                    ],
                ),
                password_field("apiKey", "API Key", "auth", "sk-...", false),
                password_field(
                    "refreshToken",
            ...
            vec![password_field("apiKey", "API Key", "auth", "sk-...", true)]
        },
        ...
        default_auth_config: if provider_id == "openai" {
            map(&[("authMode", "api_key")])
        } else {
            map(&[])
        },
        ...
        openai_like_preset(
            ...
            vec![
                model(
                    "gpt-5.1-codex",
                    "gpt-5.1-codex",
                    "ChatGPT Plus/Pro Codex model.",
                ),
                model(
                    "gpt-5.1-codex-max",
                    "gpt-5.1-codex-max",
                    "ChatGPT Plus/Pro Codex Max model.",
                ),
                model(
                    "gpt-5.1-codex-mini",
                    "gpt-5.1-codex-mini",
                    "ChatGPT Plus/Pro Codex Mini model.",
                ),
                model("gpt-5.2", "gpt-5.2", "ChatGPT Plus/Pro GPT-5.2 model."),
                model(
                    "gpt-5.2-codex",
                    "gpt-5.2-codex",
                    "ChatGPT Plus/Pro GPT-5.2 Codex model.",
                ),
                model(
                    "gpt-5.3-codex",
                    "gpt-5.3-codex",
                    "ChatGPT Plus/Pro GPT-5.3 Codex model.",
                ),
                model("gpt-5.4", "gpt-5.4", "ChatGPT Plus/Pro GPT-5.4 model."),
                model(
                    "gpt-5.4-mini",
                    "gpt-5.4-mini",
                    "ChatGPT Plus/Pro GPT-5.4 Mini model.",
                ),
            ],
            true,
        ),
