//! Trace bundle format, writer, and reducer for Lyra rollouts.
//!
//! This crate owns the trace schema. Hot-path Lyra code should depend on the
...
/// Shared recorder context for inference attempts within one Lyra turn.
...
pub use thread::LYRA_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Lyra tool boundary.
...
/// Append-only writer used by hot-path Lyra instrumentation.
