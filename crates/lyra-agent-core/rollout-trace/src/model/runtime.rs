...
/// Runtime operation requested by the model, a JS code cell, or Lyra itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_lyra_turn_id: Option<LyraTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Lyra tool boundary.
    ///
    ...
    /// they describe how Lyra executed the request, not what the caller sent.
