...
/// must not rewrite what the item body says the model saw.
...
pub struct ConversationItem {
    ...
    /// Lyra channel for assistant/tool content, when the item is channel-specific.
...
/// Lyra channel for model-visible content.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
