...
/// Lyra conversation/session UUID.
...
/// Process/session ID returned by Lyra's terminal runtime.
...
/// Canonical reduced graph for one Lyra rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Lyra rollout/session being observed. `trace_id`
    ...
    pub lyra_turns: BTreeMap<LyraTurnId, LyraTurn>,
