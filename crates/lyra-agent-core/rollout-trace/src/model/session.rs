...
/// One Lyra thread/session participating in the rollout.
///
...
/// here because request/response reconciliation makes it semantic.
...
/// Provenance for a traced Lyra thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Lyra runtime for one thread.
///
/// A Lyra turn groups protocol/runtime work for one thread activation.
