...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $LYRA_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [lyra_protocol::protocol::PatchApplyBeginEvent]
    /// and [lyra_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [lyra_protocol::protocol::ExecCommandBeginEvent]
    /// and [lyra_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
