...
import type { AutoApprovalReview } from "./AutoApprovalReview";
import type { AutoApprovalReviewAction } from "./AutoApprovalReviewAction";
 ...
 */
export type ItemAutoApprovalReviewCompletedNotification = { threadId: string, turnId: string,
/**
 ...
 */
targetItemId: string | null, decisionSource: AutoReviewDecisionSource, review: AutoApprovalReview, action: AutoApprovalReviewAction, };
