 ...
 */
export type ItemAutoApprovalReviewStartedNotification = { threadId: string, turnId: string,
/**
 ...
 */
targetItemId: string | null, review: AutoApprovalReview, action: AutoApprovalReviewAction, };
