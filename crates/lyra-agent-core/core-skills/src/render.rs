...
use lyra_otel::THREAD_SKILLS_DESCRIPTION_TRUNCATED_CHARS_METRIC;
use lyra_otel::THREAD_SKILLS_ENABLED_TOTAL_METRIC;
use lyra_otel::THREAD_SKILLS_KEPT_TOTAL_METRIC;
use lyra_otel::THREAD_SKILLS_TRUNCATED_METRIC;
use lyra_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use lyra_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
