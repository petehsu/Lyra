...
fn build_tool_suggestion_elicitation_request_uses_expected_shape() {
    ...
    let connector = DiscoverableTool::Connector(Box::new(AppInfo {
        ...
        labels: None,
        install_url: Some(
            "https://example.test/apps/google-calendar/connector_2128aebfecb84f64a069897515042a44"
                .to_string(),
        ),
        is_accessible: false,
        is_enabled: true,
    ...
    assert_eq!(
        ...
        McpServerElicitationRequestParams {
            ...
            server_name: "lyra-apps".to_string(),
            request: McpServerElicitationRequest::Form {
                meta: Some(json!(ToolSuggestMeta {
                    lyra_approval_kind: TOOL_SUGGEST_APPROVAL_KIND_VALUE,
                    tool_type: DiscoverableToolType::Connector,
...
fn build_tool_suggestion_elicitation_request_for_plugin_omits_install_url() {
    let args = ToolSuggestArgs {
        ...
        action_type: DiscoverableToolAction::Install,
        tool_id: "sample@remote-market".to_string(),
    ...
    let plugin = DiscoverableTool::Plugin(Box::new(DiscoverablePluginInfo {
        id: "sample@remote-market".to_string(),
...
fn build_tool_suggestion_meta_uses_expected_shape() {
    let meta = build_tool_suggestion_meta(
        ...
        "Gmail",
        Some("https://example.test/apps/gmail/connector_68df038e0ba48191908c8434991bbac2"),
    );
    ...
    assert_eq!(
        ...
        ToolSuggestMeta {
            ...
            tool_name: "Gmail",
            install_url: Some(
                "https://example.test/apps/gmail/connector_68df038e0ba48191908c8434991bbac2"
            ),
        },
    );
}
