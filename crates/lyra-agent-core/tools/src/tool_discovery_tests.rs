...
use lyra_app_server_protocol::AppInfo;
...
fn create_tool_suggest_tool_uses_plugin_summary_fallback() {
    assert_eq!(
        create_tool_suggest_tool(&[
            ToolSuggestEntry {
                id: "slack@remote-market".to_string(),
        ...
        ToolSpec::Function(ResponsesApiTool {
            ...
            parameters: JsonSchema::object(BTreeMap::from([
                    ...
                    (
                        "tool_id".to_string(),
                        JsonSchema::string(Some(
                                "Connector or plugin id to suggest. Must be one of: slack@remote-market, github."
                                    .to_string(),
                            ),),
                    ),
                    (
...
#[test]
fn filter_tool_suggest_discoverable_tools_for_lyra_tui_omits_plugins() {
    ...
    assert_eq!(
        filter_tool_suggest_discoverable_tools_for_client(discoverable_tools, Some("lyra-tui"),),
