...
#[command(name = "lyra-network-proxy", about = "Lyra network sandbox proxy")]
pub struct Args {}
...
impl NetworkProxyBuilder {
    ...
    pub fn managed_by_lyra(mut self, managed_by_lyra: bool) -> Self {
        self.managed_by_lyra = managed_by_lyra;
        self
    }
...
pub const ALLOW_LOCAL_BINDING_ENV_KEY: &str = "LYRA_NETWORK_ALLOW_LOCAL_BINDING";
...
mod tests {
    ...
    #[tokio::test]
    async fn non_lyra_managed_proxy_builder_uses_configured_ports() {
