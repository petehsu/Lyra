...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    match msg {
        ...
        EventMsg::Error(ev) => {
            ...
            if matches!(
                lyra_error_info,
                Some(CoreLyraErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                lyra_error_info: ev.lyra_error_info.map(V2LyraErrorInfo::from),
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                lyra_error_info: Some(V2LyraErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                lyra_error_info: Some(V2LyraErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                lyra_error_info: Some(V2LyraErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
