...
type PendingInterruptQueue = Vec<(
    ConnectionRequestId,
    crate::lyra_message_processor::ApiVersion,
)>;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: lyra_app_server_protocol::Thread,
}
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<LyraThread>>,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<LyraThread>) -> bool {
