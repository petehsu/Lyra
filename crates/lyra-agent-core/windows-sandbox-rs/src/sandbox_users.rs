...
use lyra_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "LyraSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "Lyra sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(lyra_home);
    ...
    let secrets_dir = sandbox_secrets_dir(lyra_home);
