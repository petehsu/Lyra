use crate::default_client::LyraHttpClient;
use crate::default_client::LyraRequestBuilder;
...
pub struct ReqwestTransport {
    client: LyraHttpClient,
}

impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: LyraHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<LyraRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
