...
//! `EscalateRequest` over the inherited `LYRA_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `LYRA_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use lyra_protocol::approvals::EscalationPermissions;
pub use lyra_protocol::approvals::Permissions;
