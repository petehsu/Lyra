...
use dirs::home_dir;
use lyra_app_server_protocol::PluginAuthPolicy;
use lyra_app_server_protocol::PluginInstallPolicy;
...
pub struct MarketplacePluginPolicy {
    ...
    // TODO: Surface or enforce product gating at the Lyra/plugin consumer boundary instead of
