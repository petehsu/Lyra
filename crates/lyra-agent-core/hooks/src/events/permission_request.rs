...
//!
//! This event runs in the approval path, before auto_review or user approval UI is
...
use lyra_protocol::protocol::HookOutputEntry;
use lyra_protocol::protocol::HookOutputEntryKind;
