...
use image::Rgba;
use lyra_git_utils::GhostCommit;
...
use lyra_protocol::models::DEFAULT_IMAGE_DETAIL;
...
use lyra_protocol::models::ImageDetail;
use lyra_protocol::models::LocalShellAction;
use lyra_protocol::models::LocalShellExecAction;
use lyra_protocol::models::LocalShellStatus;
...
fn for_prompt_preserves_plain_plan_mode_messages() {
    let history = create_history_with_items(vec![
        ...
        developer_msg("Only proposed_plan markup creates the approvable artifact."),
...
fn reference_context_item() -> TurnContextItem {
    TurnContextItem {
        ...
        truncation_policy: Some(lyra_protocol::protocol::TruncationPolicy::Tokens(10_000)),
    }
}
