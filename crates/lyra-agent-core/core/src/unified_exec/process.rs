...
use lyra_exec_server::ExecProcess;
use lyra_exec_server::ReadResponse as ExecReadResponse;
use lyra_exec_server::StartedExecProcess;
use lyra_exec_server::WriteStatus;
use lyra_protocol::exec_output::ExecToolCallOutput;
use lyra_protocol::exec_output::StreamOutput;
use lyra_protocol::protocol::TruncationPolicy;
use lyra_sandboxing::SandboxType;
use lyra_utils_output_truncation::formatted_truncate_text;
use lyra_utils_pty::ExecCommandSession;
use lyra_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = lyra_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
