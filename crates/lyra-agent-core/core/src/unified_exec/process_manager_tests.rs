...
fn env_overlay_for_exec_server_keeps_runtime_changes_only() {
    ...
    let request_env = HashMap::from([
        ...
        ("SHELL_SET".to_string(), "policy".to_string()),
        ("LYRA_THREAD_ID".to_string(), "thread-1".to_string()),
        ("LYRA_SANDBOX_NETWORK_DISABLED".to_string(), "1".to_string()),
    ]);
...
fn exec_server_params_use_env_policy_overlay_contract() {
    let request = ExecRequest {
        ...
        exec_server_env_config: Some(ExecServerEnvConfig {
            policy: lyra_exec_server::ExecEnvPolicy {
                inherit: lyra_config::types::ShellEnvironmentPolicyInherit::Core,
        ...
        sandbox: lyra_sandboxing::SandboxType::None,
        windows_sandbox_level: lyra_protocol::config_types::WindowsSandboxLevel::Disabled,
        windows_sandbox_private_desktop: false,
        sandbox_policy: lyra_protocol::protocol::SandboxPolicy::DangerFullAccess,
        file_system_sandbox_policy: lyra_protocol::permissions::FileSystemSandboxPolicy::from(
            &lyra_protocol::protocol::SandboxPolicy::DangerFullAccess,
        ),
        network_sandbox_policy: lyra_protocol::permissions::NetworkSandboxPolicy::Restricted,
