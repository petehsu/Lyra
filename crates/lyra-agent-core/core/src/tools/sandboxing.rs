...
use lyra_protocol::approvals::NetworkApprovalContext;
...
use lyra_sandboxing::SandboxTransformError;
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and lyra prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub policy: &'a lyra_protocol::protocol::SandboxPolicy,
