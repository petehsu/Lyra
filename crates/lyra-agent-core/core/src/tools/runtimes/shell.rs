...
use lyra_shell_command::powershell::prefix_powershell_script_with_utf8;
...
pub(crate) enum ShellRuntimeBackend {
    ...
    ///
    /// On Unix, attempts to run via the zsh-fork + `lyra-shell-escalation`
