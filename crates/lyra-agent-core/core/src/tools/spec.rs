...
use lyra_tools::AdditionalProperties;
use lyra_tools::DiscoverableTool;
use lyra_tools::JsonSchema;
use lyra_tools::ResponsesApiTool;
use lyra_tools::ToolHandlerKind;
use lyra_tools::ToolName;
use lyra_tools::ToolNamespace;
use lyra_tools::ToolRegistryPlanDeferredTool;
use lyra_tools::ToolRegistryPlanMcpTool;
use lyra_tools::ToolRegistryPlanParams;
use lyra_tools::ToolUserShellType;
use lyra_tools::ToolsConfig;
use lyra_tools::WaitAgentTimeoutOptions;
use lyra_tools::augment_tool_spec_for_code_mode;
use lyra_tools::build_tool_registry_plan;
...
pub(crate) fn build_specs_with_discoverable_tools(
    ...
    for unavailable_tool in unavailable_called_tools {
        ...
        if existing_spec_names.insert(tool_name.clone()) {
            let spec = lyra_tools::ToolSpec::Function(ResponsesApiTool {
