...
pub(crate) struct TurnContext {
    ...
    pub(crate) lyra_self_exe: Option<PathBuf>,
    pub(crate) lyra_linux_sandbox_exe: Option<PathBuf>,
...
impl TurnContext {
    ...
    pub(crate) fn apps_enabled(&self) -> bool {
        self.features.apps_enabled_for_auth(false)
    }
    ...
    pub(crate) async fn with_model(&self, model: String, models_manager: &ModelsManager) -> Self {
        ...
        Self {
            ...
            lyra_self_exe: self.lyra_self_exe.clone(),
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        TurnContext {
            ...
            lyra_self_exe: per_turn_config.lyra_self_exe.clone(),
            lyra_linux_sandbox_exe: per_turn_config.lyra_linux_sandbox_exe.clone(),
            tool_call_gate: Arc::new(ReadinessFlag::new()),
        ...
        let update_result = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                Ok(next) => {
                    ...
                    let lyra_home = next.lyra_home.clone();
