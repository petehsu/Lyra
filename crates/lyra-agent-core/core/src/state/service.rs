...
use crate::auto_review::AutoReviewRejection;
...
pub(crate) struct SessionServices {
    ...
    pub(crate) auto_review_rejections: Mutex<HashMap<String, AutoReviewRejection>>,
    ...
    pub(crate) _thread_store: LocalThreadStore,
