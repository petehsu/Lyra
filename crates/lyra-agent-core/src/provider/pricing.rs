use super::{RouteCheapnessEstimate, RouteCostConfidence, RouteCostSource};
...
pub fn copilot_pricing(model: &str, zero_premium_mode: bool) -> RouteCheapnessEstimate {
    ...
    RouteCheapnessEstimate::included_quota(
        ...
        Some(if zero_premium_mode {
            "Copilot zero-premium mode: Lyra will send requests as agent/non-premium when possible"
                .to_string()
...
mod tests {
    use super::*;
    use crate::provider::RouteBillingKind;
