...
pub struct EnvSnapshot {
    ...
    pub lyra_git_hash: Option<String>,
    pub lyra_git_dirty: Option<bool>,
    pub os: String,
    pub arch: String,
    pub pid: u32,
    pub is_selfdev: bool,
...
pub struct SessionSearchReport {
    ...
    pub scanned_lyra_sessions: usize,
    pub candidate_lyra_sessions: usize,
...
pub fn format_session_search_results(
    ...
    output.push_str(&format!(
        "_Scanned: {} Lyra sessions ({} candidates), {} external sessions{}{}._\n\n",
        report.scanned_lyra_sessions,
        report.candidate_lyra_sessions,
