...
use super::provider_control::{
    ...
    handle_set_reasoning_effort, handle_set_service_tier, handle_switch_anthropic_account,
    ...
    loop {
        ...
        match request {
            ...
            Request::SetFeature {
                ...
                handle_set_feature(id, feature, enabled, &agent, &client_event_tx).await;
            }
