        ...
        match provider {
            ...
            ActiveProvider::OpenAI => {
                if let Some(openai) = self.openai_provider() {
                    ...
                    Err(anyhow::anyhow!(
                        "OpenAI credentials not available. Sign in from Lyra Agent settings."
                    ))
                }
            }
            ActiveProvider::Copilot => {
                ...
                if let Some(copilot) = copilot {
                    ...
                    Err(anyhow::anyhow!(
                        "GitHub Copilot is not available. Sign in from Lyra Agent settings."
                    ))
                }
            }
            ActiveProvider::Antigravity => {
                ...
                if let Some(antigravity) = antigravity {
                    ...
                    Err(anyhow::anyhow!(
                        "Antigravity is not available. Sign in from Lyra Agent settings."
                    ))
                }
            }
            ActiveProvider::Gemini => {
                ...
                if let Some(gemini) = gemini {
                    ...
                    Err(anyhow::anyhow!(
                        "Gemini is not available. Sign in from Lyra Agent settings."
                    ))
                }
            }
            ActiveProvider::Cursor => {
                ...
                if let Some(cursor) = cursor {
                    ...
                    Err(anyhow::anyhow!(
                        "Cursor is not available. Sign in from Lyra Agent settings."
                    ))
                }
            }
