...
impl Config {
    ...
    pub fn create_default_config_file() -> anyhow::Result<PathBuf> {
        ...
        let default_content = r#"# Lyra Agent configuration file
# Location: ~/.lyra/modules/agent/config.toml
#
# Environment variables override these settings.
# Open the Lyra Agent config editor from Lyra Settings > AI to edit this file.
...
# ntfy_topic = "lyra-agent-ambient-your-secret-topic"
...
# email_from = "lyra-agent@example.com"
# email_smtp_host = "smtp.gmail.com"
# email_smtp_port = 587
# Password via environment or config below
# email_password = ""
