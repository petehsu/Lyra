//! Default Lyra HTTP client: shared `User-Agent` and reqwest/`LyraHttpClient`
//! construction.
//!
...
use lyra_client::LyraHttpClient;
pub use lyra_client::LyraRequestBuilder;
...
pub fn create_client() -> LyraHttpClient {
    let inner = build_reqwest_client();
    LyraHttpClient::new(inner)
}
