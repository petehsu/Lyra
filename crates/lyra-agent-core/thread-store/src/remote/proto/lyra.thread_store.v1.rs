        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ListThreadsResponse>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/lyra.thread_store.v1.ThreadStore/ListThreads",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "lyra.thread_store.v1.ThreadStore",
                "ListThreads",
            ));
...
pub mod thread_store_server {
    ...
    pub const SERVICE_NAME: &str = "lyra.thread_store.v1.ThreadStore";
