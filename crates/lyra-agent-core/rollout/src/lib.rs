//! Rollout persistence and discovery for Lyra session files.
...
pub(crate) mod default_client {
    pub use lyra_login::default_client::*;
}

pub(crate) use lyra_protocol::protocol;

pub const SESSIONS_SUBDIR: &str = "sessions";
pub const ARCHIVED_SESSIONS_SUBDIR: &str = "archived_sessions";
pub const LYRA_DESKTOP_SESSION_SOURCE: &str = "lyra";
pub static INTERACTIVE_SESSION_SOURCES: LazyLock<Vec<SessionSource>> = LazyLock::new(|| {
    vec![
        SessionSource::Cli,
        SessionSource::VSCode,
        SessionSource::Custom(LYRA_DESKTOP_SESSION_SOURCE.to_string()),
    ]
});
...
pub use lyra_protocol::protocol::SessionMeta;
