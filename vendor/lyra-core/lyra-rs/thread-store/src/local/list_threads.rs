...
pub(super) async fn list_threads(
    ...
    let sort_key = match params.sort_key {
        ThreadSortKey::CreatedAt => lyra_rollout::ThreadSortKey::CreatedAt,
        ThreadSortKey::UpdatedAt => lyra_rollout::ThreadSortKey::UpdatedAt,
    };
    let sort_direction = match params.sort_direction {
        SortDirection::Asc => lyra_rollout::SortDirection::Asc,
        SortDirection::Desc => lyra_rollout::SortDirection::Desc,
    };
...
async fn list_rollout_threads(
    ...
    params: &ListThreadsParams,
    cursor: Option<&lyra_rollout::Cursor>,
    sort_key: lyra_rollout::ThreadSortKey,
    sort_direction: lyra_rollout::SortDirection,
) -> ThreadStoreResult<lyra_rollout::ThreadsPage> {
...
mod tests {
    ...
    async fn list_threads_preserves_sqlite_title_search_results() {
        ...
        let mut builder = lyra_state::ThreadMetadataBuilder::new(
            thread_id,
            rollout_path,
            created_at,
            SessionSource::Cli,
