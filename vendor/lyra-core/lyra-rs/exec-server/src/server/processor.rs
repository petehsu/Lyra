    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                lyra_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                lyra_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                lyra_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                lyra_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
