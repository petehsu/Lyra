...
use clap::Parser;
use clap::Subcommand;
use lyra_execpolicy_legacy::ExecCall;
use lyra_execpolicy_legacy::MatchedExec;
use lyra_execpolicy_legacy::Policy;
use lyra_execpolicy_legacy::PolicyParser;
use lyra_execpolicy_legacy::ValidExec;
use lyra_execpolicy_legacy::get_default_policy;
...
pub enum Output {
    ...
    Forbidden {
        reason: String,
        cause: lyra_execpolicy_legacy::Forbidden,
    },

    /// The safety of the command could not be verified.
    #[serde(rename = "unverified")]
    Unverified {
        error: lyra_execpolicy_legacy::Error,
    },
}
