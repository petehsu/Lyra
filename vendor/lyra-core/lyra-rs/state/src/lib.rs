...
//! orchestration and rollout scanning live in `lyra-core`.
...
pub const SQLITE_HOME_ENV: &str = "LYRA_SQLITE_HOME";
...
pub const DB_ERROR_METRIC: &str = "lyra.db.error";
/// Metrics on backfill process. Tags: [status]
pub const DB_METRIC_BACKFILL: &str = "lyra.db.backfill";
/// Metrics on backfill duration. Tags: [status]
pub const DB_METRIC_BACKFILL_DURATION_MS: &str = "lyra.db.backfill.duration_ms";
