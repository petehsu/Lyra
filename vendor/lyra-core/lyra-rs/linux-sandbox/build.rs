...
/// 2. The vendored bubblewrap tree under `lyra-rs/vendor/bubblewrap`.
...
Set CODEX_BWRAP_SOURCE_DIR to an existing checkout or vendor bubblewrap under lyra-rs/vendor.",
        vendor_dir.display()
    ))
}
