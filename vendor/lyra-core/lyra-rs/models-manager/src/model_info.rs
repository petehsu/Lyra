...
use lyra_protocol::openai_models::ModelInstructionsVariables;
use lyra_protocol::openai_models::ModelMessages;
...
const DEFAULT_PERSONALITY_HEADER: &str = "You are Lyra, an AI coding assistant. You and the user share the same workspace and collaborate to achieve the user's goals.";
...
fn local_personality_messages_for_slug(slug: &str) -> Option<ModelMessages> {
    match slug {
        "gpt-5.2-codex" | "exp-lyra-personality" | _ if slug.contains("codex") => Some(ModelMessages {
