    ...
    pub async fn request_mcp_server_elicitation(
        ...
        let request = match params.request {
            McpServerElicitationRequest::Form {
                ...
                lyra_protocol::approvals::ElicitationRequest::Form {
                    meta,
                    message,
                    requested_schema,
                }
            ...
            McpServerElicitationRequest::Url {
                ...
                url,
                elicitation_id,
            } => lyra_protocol::approvals::ElicitationRequest::Url {
                meta,
                message,
                url,
                elicitation_id,
        ...
        let id = match request_id {
            rmcp::model::NumberOrString::String(value) => {
                lyra_protocol::mcp::RequestId::String(value.to_string())
            }
            rmcp::model::NumberOrString::Number(value) => {
                lyra_protocol::mcp::RequestId::Integer(value)
            }
        };
