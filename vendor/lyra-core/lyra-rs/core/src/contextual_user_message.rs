use lyra_instructions::AGENTS_MD_FRAGMENT;
use lyra_instructions::ContextualUserFragmentDefinition;
use lyra_instructions::SKILL_FRAGMENT;
use lyra_protocol::items::HookPromptItem;
use lyra_protocol::items::parse_hook_prompt_fragment;
use lyra_protocol::models::ContentItem;
use lyra_protocol::protocol::ENVIRONMENT_CONTEXT_CLOSE_TAG;
use lyra_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
