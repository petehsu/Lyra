...
impl SkillsManager {
    pub fn new(lyra_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(lyra_home, bundled_skills_enabled, Some(Product::Lyra))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.lyra_home);
        } else if let Err(err) = install_system_skills(&manager.lyra_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &lyra_config::ConfigLayerStack,
) -> bool {
