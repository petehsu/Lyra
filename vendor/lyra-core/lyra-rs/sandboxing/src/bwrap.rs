...
const MISSING_BWRAP_WARNING: &str = concat!(
    "Lyra could not find bubblewrap on PATH. ",
    "Install bubblewrap with your OS package manager. ",
    "See the sandbox prerequisites in the documentation. ",
    "Lyra will use the vendored bubblewrap in the meantime.",
);
const USER_NAMESPACE_WARNING: &str =
    "Lyra's Linux sandbox uses bubblewrap and needs access to create user namespaces.";
pub(crate) const WSL1_BWRAP_WARNING: &str = concat!(
    "Lyra's Linux sandbox uses bubblewrap, which is not supported on WSL1 ",
