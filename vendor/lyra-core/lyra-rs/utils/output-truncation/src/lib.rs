//! Helpers for truncating tool and exec output using [`TruncationPolicy`](lyra_protocol::protocol::TruncationPolicy).

use lyra_protocol::models::FunctionCallOutputContentItem;
pub use lyra_utils_string::approx_bytes_for_tokens;
pub use lyra_utils_string::approx_token_count;
pub use lyra_utils_string::approx_tokens_from_byte_count;
use lyra_utils_string::truncate_middle_chars;
use lyra_utils_string::truncate_middle_with_token_budget;

pub use lyra_protocol::protocol::TruncationPolicy;
