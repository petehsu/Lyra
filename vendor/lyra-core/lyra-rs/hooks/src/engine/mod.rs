...
pub(crate) struct ConfiguredHandler {
    pub event_name: lyra_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            lyra_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            lyra_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            lyra_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            lyra_protocol::protocol::HookEventName::SessionStart => "session-start",
            lyra_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
