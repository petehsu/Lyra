...
use lyra_protocol::protocol::HookExecutionMode;
use lyra_protocol::protocol::HookHandlerType;
use lyra_protocol::protocol::HookRunStatus;
use lyra_protocol::protocol::HookRunSummary;
use lyra_protocol::protocol::HookScope;
...
pub(crate) fn completed_summary(
    ...
    entries: Vec<lyra_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
