import { enUS, type NotificationMessages } from "./en-US";
import { zhCN } from "./zh-CN";

export type { NotificationMessages };

const CATALOGS: Readonly<Record<string, NotificationMessages>> = {
  "en-US": enUS,
  "zh-CN": zhCN
};
...
export const resolveMessages = (locale: string): NotificationMessages => {
