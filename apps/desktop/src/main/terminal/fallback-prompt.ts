...
const createBashResetPromptCommand = (): string =>
  [
    ...
    "trap - DEBUG",
    "unset __lyra_prompt_cmd_start __lyra_bash_command_running __lyra_bash_in_prompt",
    "unset -f __lyra_git_branch __lyra_prompt_symbol __lyra_prompt_duration __lyra_preexec __lyra_precmd __lyra_osc __lyra_url_escape __lyra_emit_cwd 2>/dev/null",
...
const createBashLyraPromptCommand = (
  ...
  return [
    ...
    "}",
    "__lyra_preexec() {",
    "  if [ \"${__lyra_bash_in_prompt:-0}\" = \"1\" ]; then return; fi",
    '  case "$BASH_COMMAND" in',
    "    __lyra_*|trap\\ *|PROMPT_COMMAND=*) return ;;",
    "  esac",
    "  if [ \"${__lyra_bash_command_running:-0}\" = \"0\" ]; then",
    "    __lyra_osc '133;B'",
    ...
    "  if [ \"${__lyra_bash_command_running:-0}\" = \"1\" ]; then",
...
const createZshResetPromptCommand = (): string =>
  [
    ...
    "unfunction __lyra_git_branch __lyra_prompt_symbol __lyra_prompt_duration __lyra_preexec __lyra_precmd __lyra_osc __lyra_url_escape __lyra_emit_cwd >/dev/null 2>&1",
    "stty erase '^?' >/dev/null 2>&1 || true",
...
const createZshLyraPromptCommand = (
  ...
  return [
    ...
    "__lyra_precmd() {",
    "  local exit_code=$?",
    "  if [[ \"${__lyra_zsh_command_running:-0}\" == \"1\" ]]; then",
    "    __lyra_osc \"133;D;${exit_code}\"",
    "    __lyra_osc \"633;CommandEnd;exitCode=${exit_code}\"",
    "    __lyra_zsh_command_running=0",
    "  fi",
