...
const ZH_MESSAGES = {
  ...
  "composer.permissionModeList": "权限模式列表",
  "composer.permissionModeApproval": "审批",
  "composer.permissionModeFullAuto": "全自动",
  "composer.permissionModeCustom": "自定义",
...
const EN_MESSAGES: Messages = {
  ...
  "composer.permissionModeList": "Permission mode list",
  "composer.permissionModeApproval": "Approval",
  "composer.permissionModeFullAuto": "Full auto",
  "composer.permissionModeCustom": "Custom",
