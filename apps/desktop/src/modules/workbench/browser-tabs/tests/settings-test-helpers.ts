...
export const createBrowserSettingsSurfaceProps = (
  ...
  accountLabels: {
    title: "Account",
    cloudAccount: "Lyra account",
    localAccount: "Local account",
    deviceScope: "This device",
    edit: "Edit profile",
    displayName: "Display name",
    avatarUrl: "Avatar URL",
    avatarUrlPlaceholder: "https://",
    avatarUrlDescription: "Use an HTTPS URL.",
    save: "Save",
    cancel: "Cancel",
    ...
    coverageDetail: "{reported} of {eligible} provider turns reported token usage.",
    incompleteCoverageDetail: "{count} turns contain partial telemetry.",
    ...
    deleteDescription: "Delete cloud account data.",
    dayUnit: "days",
    secondUnit: "s",
    minuteUnit: "m",
    hourUnit: "h"
  ...
  importSettingsLabels: {
    ...
    noContent: "Nothing to sync",
    skills: "Skills",
    mcp: "MCP",
    back: "Import Settings",
    loading: "Working",
  ...
  softwareStore: {
    ...
    labels: {
      ...
      appUpdateTitle: "Lyra updates",
      appUpdateDescription: "Check, download, and install a new Lyra version.",
      appUpdateCurrentVersion: "Current version",
      appUpdateAvailableVersion: "New version available",
      appUpdateCheck: "Check for updates",
      appUpdateDownload: "Download update",
      appUpdateRetry: "Retry",
      appUpdateRestart: "Restart and update",
