...
export const createBrowserSettingsSurfaceProps = (
  ...
  aiToolDisplayModeInnerScrollLabel: "Inner scroll",
  aiToolDisplayModeCollapsedLabel: "Collapsed",
  ...
  aiToolDisplayModeValue: "inner_scroll",
  ...
  onAiToolDisplayModeChange: noop,
