...
export const createBrowserSettingsSurfaceProps = (
  ...
  loginManager: {
    ...
    labels: {
      ...
      emptySessionsDescription: "No login sessions were found.",
      emptyCredentialsTitle: "No passwords",
      emptyCredentialsDescription: "No saved passwords were found.",
      openSite: "Open site",
  ...
  softwareStore: {
    ...
    labels: {
      ...
      emptyDescription: "Adjust your search or filter.",
      typeLabel: "Type",
