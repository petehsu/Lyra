...
export const useWorkbenchLabels = (t: WorkbenchTranslator) =>
  useMemo(
    () => ({
      ...
      agentVm: {
        title: t("agentVm.title"),
        subtitle: t("agentVm.subtitle"),
        create: t("agentVm.create"),
        createSessionTitle: t("agentVm.createSessionTitle"),
        defaultImage: t("agentVm.defaultImage"),
        imageMissing: t("agentVm.imageMissing"),
        downloadAndStart: t("agentVm.downloadAndStart"),
        preparing: t("agentVm.preparing"),
        checkingImage: t("agentVm.checkingImage"),
        downloadingImage: t("agentVm.downloadingImage"),
        creatingVm: t("agentVm.creatingVm"),
        startingVm: t("agentVm.startingVm"),
        downloadProgress: t("agentVm.downloadProgress"),
        downloadFailed: t("agentVm.downloadFailed"),
        downloadManagerUnavailable: t("agentVm.downloadManagerUnavailable"),
        importImage: t("agentVm.importImage"),
        imageInstalled: t("agentVm.imageInstalled"),
        refresh: t("agentVm.refresh"),
        unavailable: t("agentVm.unavailable"),
        empty: t("agentVm.empty"),
        loading: t("agentVm.loading"),
        vmId: t("agentVm.vmId"),
        state: t("agentVm.state"),
        image: t("agentVm.image"),
        workspace: t("agentVm.workspace"),
        ownerSession: t("agentVm.ownerSession"),
        attachedSessions: t("agentVm.attachedSessions"),
        updatedAt: t("agentVm.updatedAt"),
        start: t("agentVm.start"),
        stop: t("agentVm.stop"),
        loginUser: t("agentVm.loginUser"),
        loginPassword: t("agentVm.loginPassword"),
        showPassword: t("agentVm.showPassword"),
        copyPassword: t("agentVm.copyPassword"),
        passwordCopied: t("agentVm.passwordCopied"),
        passwordUnavailable: t("agentVm.passwordUnavailable"),
        attach: t("agentVm.attach"),
        takeover: t("agentVm.takeover"),
        fork: t("agentVm.fork"),
        inherit: t("agentVm.inherit"),
        scopedSession: t("agentVm.scopedSession"),
        noSessionScope: t("agentVm.noSessionScope"),
        actionFailed: t("agentVm.actionFailed"),
        console: t("agentVm.console"),
        consoleConnecting: t("agentVm.consoleConnecting"),
        consoleConnected: t("agentVm.consoleConnected"),
        consoleDisconnected: t("agentVm.consoleDisconnected"),
        consoleUnavailable: t("agentVm.consoleUnavailable"),
        consoleStopped: t("agentVm.consoleStopped"),
        consoleNoPort: t("agentVm.consoleNoPort"),
        activeVm: t("agentVm.activeVm"),
        vmList: t("agentVm.vmList"),
        connection: t("agentVm.connection"),
        sshPort: t("agentVm.sshPort"),
        vncPort: t("agentVm.vncPort"),
        liteProfile: t("agentVm.liteProfile")
      },
      workspaceI18n: {
      ...
      aiHistory: {
        ...
        unarchiveConversationLabel: t("ai.unarchiveConversation"),
