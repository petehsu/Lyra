...
export const location = {
  ...
  "location.authDialogDescription": "Lyra 会尝试通过浏览器和系统获取物理位置，并显示可读的地点名称。授权后，位置会提供给 Agent 作为上下文；无法解析地点名称时，可能改用位置坐标。",
  ...
  "location.revokeDialogDescription": "取消后 Lyra 会清除缓存的地点名称和坐标，并停止向 Agent 提供位置上下文。以后仍可点击定位按钮重新授权。",
  "location.revokeDialogSubtitle": "位置上下文会提供给 Agent",
