...
export const TEST_ZH_CN_DICTIONARY: Record<string, string> = {
  ...
  "tool.agents": "{count} 个 Agent",
  "tool.agents_one": "{count} 个 Agent",
  "tool.agents_other": "{count} 个 Agent",
  "tool.summary.reads": "{count} 次读取",
  "tool.summary.reads_one": "{count} 次读取",
  "tool.summary.reads_other": "{count} 次读取",
  "tool.summary.searches": "{count} 次搜索",
  "tool.summary.searches_one": "{count} 次搜索",
  "tool.summary.searches_other": "{count} 次搜索",
  "tool.summary.edits": "{count} 处编辑",
  "tool.summary.edits_one": "{count} 处编辑",
  "tool.summary.edits_other": "{count} 处编辑",
  "tool.summary.commands": "{count} 条命令",
  "tool.summary.commands_one": "{count} 条命令",
  "tool.summary.commands_other": "{count} 条命令",
  "tool.summary.browses": "{count} 次浏览",
  "tool.summary.browses_one": "{count} 次浏览",
  "tool.summary.browses_other": "{count} 次浏览",
  "tool.summary.asks": "{count} 个提问",
  "tool.summary.asks_one": "{count} 个提问",
  "tool.summary.asks_other": "{count} 个提问",
