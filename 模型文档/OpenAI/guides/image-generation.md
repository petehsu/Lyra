...
[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/sci-fi-hangar.png)](/docs/guides/image-generation?gallery=open&galleryItem=sci-fi-hangar)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/mechanical-bouquet.png)](/docs/guides/image-generation?gallery=open&galleryItem=mechanical-bouquet)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/mechanical-watch.png)](/docs/guides/image-generation?gallery=open&galleryItem=mechanical-watch)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/botanical-perfume.png)](/docs/guides/image-generation?gallery=open&galleryItem=botanical-perfume)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/lavender-sunrise.png)](/docs/guides/image-generation?gallery=open&galleryItem=lavender-sunrise)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/winter-wolf-portrait.png)](/docs/guides/image-generation?gallery=open&galleryItem=winter-wolf-portrait)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/desert-sunrise-portrait.png)](/docs/guides/image-generation?gallery=open&galleryItem=desert-sunrise-portrait)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/chess-set.png)](/docs/guides/image-generation?gallery=open&galleryItem=chess-set)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/underwater-ballerina.png)](/docs/guides/image-generation?gallery=open&galleryItem=underwater-ballerina)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/album-cover.png)](/docs/guides/image-generation?gallery=open&galleryItem=album-cover)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/abstract-orbit.png)](/docs/guides/image-generation?gallery=open&galleryItem=abstract-orbit)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/alien.png)](/docs/guides/image-generation?gallery=open&galleryItem=alien)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/icons-poster.png)](/docs/guides/image-generation?gallery=open&galleryItem=icons)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/3d-city.png)](/docs/guides/image-generation?gallery=open&galleryItem=3d-city)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/ink-wash-temple.png)](/docs/guides/image-generation?gallery=open&galleryItem=ink-wash-temple)[![](https://cdn.openai.com/API/docs/images/images-gallery-1p5/cliffside-portrait.png)](/docs/guides/image-generation?gallery=open&galleryItem=cliffside-portrait)
...
The image generation tool in responses supports `gpt-image-1` and `gpt-image-1-mini`. We're working on support for `gpt-image-1.5`.
For a list of mainline models that support calling this tool, refer to the [supported models](/docs/guides/image-generation#supported-models) below.
...
from your [developer
console](https://platform.openai.com/settings/organization/general) before using GPT
Image models, including `gpt-image-1.5`, `gpt-image-1`, and `gpt-image-1-mini`.
...
Please note that right now, only `gpt-image-1` and `gpt-image-1-mini` are supported in
the Responses API. We're working on support for `gpt-image-1.5`.
