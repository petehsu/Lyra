...
[![](https://cdn.openai.com/devhub/gpt5prompts/ocean-wave-simulation-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=ocean-wave-simulation-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/brutalist-dev-landing-page-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=brutalist-dev-landing-page-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/solar-system-explorer-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=solar-system-explorer-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/customer-journey-flow-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=customer-journey-flow-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/asteroid-game-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=asteroid-game-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/employee-skills-matrix-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=employee-skills-matrix-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/virtual-drum-kit-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=virtual-drum-kit-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/camping-gear-checklist-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=camping-gear-checklist-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/weather-theatre-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=weather-theatre-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/typing-rain-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=typing-rain-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/holiday-card-for-kids-5.2.png)](/docs/guides/latest-model?gallery=open&galleryItem=holiday-card-for-kids-5.2)[![](https://cdn.openai.com/devhub/gpt5prompts/cloud-painter.png)](/docs/guides/latest-model?gallery=open&galleryItem=cloud-painter)[![](https://cdn.openai.com/devhub/gpt5prompts/audio-step-sequencer.png)](/docs/guides/latest-model?gallery=open&galleryItem=audio-step-sequencer)[![](https://cdn.openai.com/devhub/gpt5prompts/farewell-message-board.png)](/docs/guides/latest-model?gallery=open&galleryItem=farewell-message-board)[![](https://cdn.openai.com/devhub/gpt5prompts/csv-to-charts.png)](/docs/guides/latest-model?gallery=open&galleryItem=csv-to-charts)[![](https://cdn.openai.com/devhub/gpt5prompts/espresso.png)](/docs/guides/latest-model?gallery=open&galleryItem=espresso)
...
| Variant | Best for |
| --- | --- |
| [`gpt-5.2`](/docs/models/gpt-5.2) | Complex reasoning, broad world knowledge, and code-heavy or multi-step agentic tasks |
| [`gpt-5.2-pro`](/docs/models/gpt-5.2-pro) | Tough problems that may take longer to solve but require harder thinking |
...
| [`gpt-5-mini`](/docs/models/gpt-5-1-mini) | Cost-optimized reasoning and chat; balances speed, cost, and capability |
...
Craft the perfect prompt for GPT-5.2 in the dashboard](/chat/edit?optimize=true)
[GPT-5.2 prompting guide

Learn full best practices for prompting GPT-5 models](https://cookbook.openai.com/examples/gpt-5/gpt-5_prompting_guide)
[Frontend prompting for GPT-5

See prompt samples specific to frontend development for GPT-5 family of models](https://cookbook.openai.com/examples/gpt-5.2/gpt-5.2_frontend)
