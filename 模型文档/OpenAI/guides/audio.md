...
| --- | --- | --- |
| [Realtime API](/docs/api-reference/realtime) | Audio and text inputs and outputs | Audio streaming in, audio and text streaming out |
| [Chat Completions API](/docs/api-reference/chat) | Audio and text inputs and outputs | Audio and text streaming out |
| [Transcription API](/docs/api-reference/audio) | Audio inputs | Text streaming out |
